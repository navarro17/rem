...
@section ('contenido')
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <h3>Listado de Proyectos <a href="proyecto/create"><button class="btn btn-success">Nuevo Proyecto</button></a></h3>
            @include('Rem.proyecto.search')
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::action('ProyectoController@edit', $pro->idProyecto)}}"><button class="btn btn-info">Editar</button></a>

                            
                            <a href="" data-target="#modal-delete-{{$pro->idProyecto}}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>
                        </td>
                    </tr>
                    @include('Rem.proyecto.modal')
                    @endforeach
                </table>
            </div>
            {{$proyecto->render()}}
