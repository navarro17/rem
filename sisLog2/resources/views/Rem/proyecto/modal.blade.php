<div class="modal fade modal-slide-in-rigth" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$pro->idProyecto}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminar Registro del Preoyecto</h4>
            </div>
            <div class="modal-body">
                <p>Confirme si desea Eliminar el registro del Proyecto</p>
            </div>
